...
public class BaseCounterTest {
    ...
    public void testGetPercentages() {
        ...
        nl.tudelft.context.model.graph.Node node1 = nodeParser.getNode(new Scanner(">0 | Cat,Dog | 5 | 7\nA\n"));
        nl.tudelft.context.model.graph.Node node2 = nodeParser.getNode(new Scanner(">1 | Dog | 8 | 10\nATC\n"));
