...
public class ResistanceCausingMutationFilterTest {

    File nodeFile = new File(ResistanceCausingMutationFilterTest.class.getResource("/graph/node.graph").getPath());
    File edgeFile = new File(ResistanceCausingMutationFilterTest.class.getResource("/graph/edge.graph").getPath());
    ...
    public void setUp() throws InterruptedException, ExecutionException, TimeoutException {
        ...
        codingGraph = new ResistanceCausingMutationFilter(graph).getFilterGraph();
    ...
    public void testRemoved() {
        ...
        assertFalse(codingGraph.containsVertex(nodeMap.get(3))); // Removed node
